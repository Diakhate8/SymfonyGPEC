...
class ModaliteString{
    ...
    public function modStringSix($dataSc){   
        if(empty($dataSc->premierE)||empty($dataSc->premierMont)){
            ...
            $premierE = "\n01e Echéancier :".$dataSc->premierE." ".$dataSc->premierMont.
        ...
        if(empty($dataSc->deuxiemeE)||empty($dataSc->deuxiemeMont)){
            ...
            $deuxiemeE = "\n02e Echéancier :".$dataSc->deuxiemeE." ".$dataSc->deuxiemeMont.
        ...
        if(empty($dataSc->troisiemeE)||empty($dataSc->troisiemeMont) ){
            ...
            $troisiemeE = "\n03e Echéancier :".$dataSc->troisiemeE." ".$dataSc->troisiemeMont." ".
            $this->toWords->inWords($dataSc->troisiemeMont)." ".$this->devise ;
        }

        if(empty($dataSc->quatriemeE)||empty($dataSc->quatriemeMont)){
            $quatriemeE = $this->formatNull; 
        }else{
            $quatriemeE = "0\n4e Echéancier :".$dataSc->quatriemeE." ".$dataSc->quatriemeMont.
        ...
        if(empty($dataSc->cinquiemeE)||empty($dataSc->cinquiemeMont) ){
            ...
            $cinquiemeE = "0\n4e Echéancier :".$dataSc->cinquiemeE." ".$dataSc->cinquiemeMont.
        ...
        if(empty($dataSc->sixiemeE)||empty($dataSc->sixiemeMont)){
            ...
            $sixiemeE = "\n06e Echéancier :".$dataSc->sixiemeE." ".$dataSc->sixiemeMont.
        ...
        if(empty($dataSc->septiemeE)||empty($dataSc->septiemeMont)){
            ...
            $septiemeE = "\n07e Echéancier :".$dataSc->septiemeE." ".$dataSc->septiemeMont.
        ...
        if(empty($dataSc->huitiemeE)||empty($dataSc->huitiemeMont) ){
            ...
            $huitiemeE = "\n08e Echéancier :".$dataSc->huitiemeE." ".$dataSc->huitiemeMont.
        ...
        if(empty($dataSc->neuviemeE)||empty($dataSc->neuviemeMont) ){
            ...
            $neuviemeE = "\n09e Echéancier :".$dataSc->neuviemeE." ".$dataSc->neuviemeMont.
            " ".$this->toWords->inWords($dataSc->neuviemeMont )." ".$this->devise ; 
        }
        if(empty($dataSc->dixiemeE)||empty($dataSc->dixiemeMont) ){
            $dixiemeE=$this->formatNull; 
        }else{
            $dixiemeE = "\n10e Echéancier :".$dataSc->dixiemeE
            ." ".$dataSc->dixiemeMont." ".$this->toWords->inWords($dataSc->dixiemeMont).
            " ".$this->devise ;   
        }
        if(empty($dataSc->onziemeE)||empty($dataSc->onziemeMont) ){
            $onziemeE=$this->formatNull; 
        }else{
            $onziemeE = "\n11e Echéancier :".$dataSc->onziemeE." ".$dataSc->onziemeMont.
            " ".$this->toWords->inWords($dataSc->onziemeMont )." ".$this->devise ;   
        }
        if(empty($dataSc->douziemeE)||empty($dataSc->douziemeMont) ){
            $douziemeE=$this->formatNull; 
        }else{
            $douziemeE = "\n12e Echéancier :".$dataSc->douziemeE." ".$dataSc->douziemeMont.
            " ".$this->toWords->inWords($dataSc->douziemeMont)." ".$this->devise ;  
        }
