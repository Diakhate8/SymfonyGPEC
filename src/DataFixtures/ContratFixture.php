...
class ContratFixture extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $contrat->setPreambule("PREAMBULE:
         \n_ « Le vendeur » est une société spécialisée dans la vente à tempérament de produits électroménagers, des ordinateurs, des smartphones et de meubliers etc. Elle permet à ses clients de faire des paiements fractionnés en plusieurs versements échelonnés sur une certaine durée.
